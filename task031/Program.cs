...
// Например, в массив [3,9,-8,1,0,-7,2,-1,8,-3,-1,6]
// сумма положительных чисел равна 29, а отрицательных
// равна -20
...
int[] SumPositiveNegativElem(int[] arr)
{
    int sumpositive = 0;
    int sumnegative = 0;
    for (int i = 0; i < arr.Length; i++)
...
int[] sumPositiveNegativeElem = SumPositiveNegativElem(array);
